...
@section('content')
    <header class="rd-page-header">
        <div class="rd-page-header__copy">
            ...
            <p class="rd-page-header__description">{{ $canEdit ? 'Maintain membership behavior and cross-group access.' : 'Review membership behavior and cross-group access.' }}</p>
        </div>
    ...
    <div class="rd-card rd-card--quiet rd-max-w-md">
        <div class="rd-card__body">
            @unless ($canEdit)
                <div class="rd-callout rd-callout--info"><i class="ri-eye-line" aria-hidden="true"></i><p>You have view-only access to user groups.</p></div>
            @endunless
            <form class="rd-liveform rd-stack rd-stack--lg" data-url="{{ route('admin.groups.update', $group) }}" data-method="PUT">
                ...
                <div class="rd-field">
                    ...
                    <div class="rd-actions rd-actions--wrap">
                        ...
                        @empty
                            <span class="rd-muted">No additional user groups.</span>
                        @endforelse
                    </div>
                    @endif
