                        ...
                        <tr>
                            ...
                            <td>
                                <div class="rd-table__actions">
                                    <a href="{{ route('admin.remote', ['peer' => $device->rustdesk_id]) }}" class="rd-btn rd-btn--ghost" title="Open the remote control screen with this ID filled in. Nothing connects until you press Connect there."><i class="ri-remote-control-line" aria-hidden="true"></i> Connect</a>
