        ...
        <div class="rd-card__body rd-stack rd-stack--lg">
            ...
            <form method="POST" action="{{ route('admin.oauth-providers.update', $provider) }}" class="rd-stack rd-stack--lg">
                ...
                <div class="rd-field">
                    ...
                    <input class="rd-input rd-input--mono" id="groups_claim" name="groups_claim" value="{{ old('groups_claim', $provider->groups_claim) }}" placeholder="groups" aria-describedby="groups-claim-help"
