...
> ✅ **Stable release: [v1.4.1](https://github.com/GigaionLLC/RD-API-Server/releases/tag/v1.4.1).**
...
> connect. Review the **[release notes](docs/releases/v1.4.1.md)** for the trade-off that arrangement
> makes, and **[v1.4.0](docs/releases/v1.4.0.md)** for what the viewer does and does not do yet.
...
`RUSTDESK_API_IMAGE=ghcr.io/gigaionllc/rustdesk-api-server:1.4.1`; `latest` moves only with a
