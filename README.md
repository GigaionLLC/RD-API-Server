...
> ✅ **Stable release: [v1.5.0](https://github.com/GigaionLLC/RD-API-Server/releases/tag/v1.5.0).**
...
> Review the **[release notes](docs/releases/v1.5.0.md)**, and **[v1.4.0](docs/releases/v1.4.0.md)**
...
local `.env` file with your DB password and RustDesk endpoints. `ADMIN_PASS` is optional: omit it
...
`RUSTDESK_API_IMAGE=ghcr.io/gigaionllc/rustdesk-api-server:1.5.0`; `latest` moves only with a
verified, annotated stable release tag.

```env
# Optional: omit to have one generated and shown once at first boot.
...
- **[v1.5.0 release notes](docs/releases/v1.5.0.md)** — searchable pickers everywhere a list can
  grow, and a scope-picker leak
- **[v1.4.6 release notes](docs/releases/v1.4.6.md)** — the shipped examples say which half of the
  key pair belongs where
...
- **[v1.4.3 release notes](docs/releases/v1.4.3.md)** — the published viewer layout that stopped it
  running at all
- **[v1.4.2 release notes](docs/releases/v1.4.2.md)** — the Remote control screen, and why nothing
  connects on its own
- **[v1.4.1 release notes](docs/releases/v1.4.1.md)** — standing the remote desktop up without a
  reverse-proxy change, and the diagnostics page
