...
|---|---|---|---|
| 2026-07-17 | v1.0.1 | OpenAI Codex / GPT-5 | Prepared the dark-default patch release with preserved explicit light preference, one shared runtime-extension layer per architecture, native AMD64/ARM64 image jobs, digest-first smoke tests, and exact-commit CI-gated manifest publication. Local Docker gates passed 538 PHPUnit tests / 3,051 assertions and 69 Playwright tests with 15 intentional skips plus static, dependency, packaging, workflow, and fresh-runtime checks. No database schema or RustDesk wire-contract change. |
...
|---|---|---|---|---|
| **v1.0.1** | 2026-07-17 | Patch | GigaionLLC / OpenAI Codex | Dark mode defaults on first visit while saved light mode persists; runtime images reuse one PHP extension layer and publish from native AMD64/ARM64 runners only after exact-commit quality and digest smoke gates pass. |
